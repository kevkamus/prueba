...
<div class="row page-titles">
	<div class="col-md-5 col-8 align-self-center">
		<h3 class="text-themecolor">Kardex almacén</h3>
		<ol class="breadcrumb">
			<li class="breadcrumb-item"><a href="<c:url value="/kardex/pageKardex"/>">Configuración</a></li>
			<li class="breadcrumb-item active">Base de datos cliente</li>
		</ol>
	</div>
</div>
<!-- Start Page Content -->
						...
						<div class="modal-content">
							<div class="modal-header">
								<h4 class="modal-title" id="myModalLabel">
									<i class="fas fa-file"></i>&nbsp; Nuevo kardex almacén
								</h4>
									...
									<div class="card card-body">
										<form id="formNew" class="form-horizontal" data-toggle="validator" role="form">
											<div class="form-group row">
												<label for="cboMoneda"
													class="col-sm-4 text-right control-label col-form-label">Moneda:</label>
												<div class="col-sm-8">
													<select id="cboMoneda" class="form-control select2" style="width: 100%" required>
														<option value="">Seleccione una moneda</option>
														<option value="DE">SOLES</option>
														<option value="PR">DOLARES</option>
														<option value="PY">EUROS</option>
													</select>
												</div>
											</div>
											<div class="form-group row">
						...
						<tbody>
							<tr>
								...
								<td style="text-align: center;"><a
									...
									&nbsp;&nbsp; <a class="btn btn-success btn-xs margin_button"
									title="Detalle"><i class="fas fa-eye fa-lg"
